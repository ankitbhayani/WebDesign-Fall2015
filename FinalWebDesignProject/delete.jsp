...
<%
	  ...
	  //out.println(request.getParameterValues("msgList")[0].substring(0,9);
	  //out.println(request.getParameterValues("msgList")[0].substring(9,18));
	  ...
	  try
      {
		...
		con = DriverManager.getConnection("jdbc:mysql://localhost/contacts?user=kareena&password=kapoor");
         ...
         {
         	count = stmt.executeUpdate("DELETE FROM messages WHERE messageID=" + Integer.parseInt(messages[i]));
