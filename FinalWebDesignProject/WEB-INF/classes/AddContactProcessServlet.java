...
public class AddContactProcessServlet extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			out.println("<HTML>");
      out.println("<HEAD>");
      out.println("<TITLE>Contact Added Successfully</TITLE>");
      out.println("</HEAD>");
      out.println("<BODY>");
      out.println("<CENTER>");
      ...
      try
      {
         ...
         out.println("<H2>Message was sent successfully</H2>");
