...
<%
      try {
		...
		con = DriverManager.getConnection("jdbc:mysql://localhost/contacts?user=kareena&password=kapoor");
		 ...
		 if (!rs.isBeforeFirst() ) {
             			throw new RuntimeException("Sorry No records with this user ID");
             }	
		 
		 
         
         out.println("<TABLE BGCOLOR='#EFEFFF' CELLPADDING='2' CELLSPACING='4' BORDER='1' class='table'>");
         ...
         while (rs.next()) {
            ...
            out.println("<TD><A href='details.jsp?type=2&data=" + lookupName + "'><IMG SRC='images/product-details-button.png'></A></TD>");
