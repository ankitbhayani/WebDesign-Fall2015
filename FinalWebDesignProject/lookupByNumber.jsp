...
%>
    ...
    %>
         <div class="container">
		 <TABLE BGCOLOR='#EFEFFF' CELLPADDING='2' CELLSPACING='4' BORDER='1' class="table">
		<TR BGCOLOR='#D6DFFF'>
    ...
    %>   
			...
			<TD><%=aboutUser%></TD>
			<TD><A href='details.jsp?type=1&data=<%=lookupID%>'><IMG SRC='images/product-details-button.png'></A></TD>
