...
<h1> NEU DateFinder Registration form (1/7) </h1>
<form name="frmStep1" class="form-group" method="post" action="register_02.jsp" onSubmit="return validateFormfrmStep1()">

<div class="table-responsive">
<table class="table" bgcolor='white' cellspacing="5" cellpadding="5" border="1">
<tr>
<td>User Name:</td>
<td><input type="text" name="UserName" value="" maxlength=25" size="20"></td>
</tr>

<tr>
<td>Password:</td>
<td><input type="password" name="Password" value="" maxlength=16" size="20">&nbsp;(confidential)</td>
</tr>

<tr>
<td>Re-enter your password:</td>
<td><input type="password" name="Password2" value="" maxlength=16" size="20">&nbsp;</td>
</tr>

<tr><td>Date of Birth:</td>
<td><select name="BirthDate_month" >
...
<td>Email address:</td>
<td><input type="text" name="Email" value=""  size="20">&nbsp;(confidential)</td>
</tr>

<tr>
<td>You are a:</td>
<td>
   <input type="radio" name="GenderID" value="Male"> Male
...
<td>Looking for a:</td>
<td>
   <input type="radio" name="SeekingGenderID" value="Male"> Male
   <input type="radio" name="SeekingGenderID" value="Female"> Female
</td>
</tr>
...
<td><input type="text" name="State" value=""  onChange="stripWhiteSpace(this);" size="20"></td>
</tr>

<tr>
<td valign=middle >City:</td>
<td><input type="text" name="City" value=""  onChange="stripWhiteSpace(this);" size="20"></td>
</tr>

<tr>
<td valign=middle >Zip Code:</td>
<td><input type="text" name="PostalCode" value=""  onChange="stripWhiteSpace(this);" size="20"></td>
</tr>
...
<tr>
<td colspan="3" align="center"><input type="image" name="btnContinue" src="images/become-a-member-button.png" width="227" height="35" alt="Login"></td>
</tr>
